...
(function(){
        function Zoom(object){
                ...
                if(this.lis.length>4){//判断图片数是否超出显示区域，是的话就注册滚动事件
                    this.s=this.lis.length-4;//获取多余出来的图片数
                    this.scrollObj.width(120*this.lis.length+"px");//当图片数超出默认值时，设置ul的宽度
        ...
        Zoom.prototype={
            scrollLeft:function(){
                ...
                this.l--;
                this.scrollObj.animate({left:this.l*122+"px"},"fast");   
                },
